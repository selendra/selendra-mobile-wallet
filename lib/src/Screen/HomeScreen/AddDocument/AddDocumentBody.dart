...
Widget bodyWidget(
  ...
  return SingleChildScrollView(
    ...
    child: Column(
      children: <Widget>[
        /* App Bar */ 
        appBar('Fill Document', popScreen, Colors.white),
        /* Field User Input */
        Container(
            ...
            children: <Widget>[
              Row(
                ...
                children: <Widget>[
                  ...
                  Flexible(
                    child: textFieldAddProfile("Document No.", textChanged, 0.0, 0.0)
                  ),
                          ...
                          onPressed: () async {
                            ...
                            if (imageFile != null ) {
                              await Future.delayed(Duration(seconds: 1), () async {
                                http.StreamedResponse response = await upLoadImage(imageFile);
