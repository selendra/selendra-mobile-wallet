...
Widget allTrxBoyWidget(List<dynamic> trxHistory) {
  return trxHistory == null ? Container(
  ...
  : ListView.builder(
    ...
    itemCount: trxHistory.length,
    itemBuilder: (BuildContext context, int index) {
      return trxHistory[index]["transaction_successful"] == true 
      ? Container(
          ...
          child: Row(
            ...
            children: <Widget>[
              ...
              Expanded(
                ...
                crossAxisAlignment: CrossAxisAlignment.start,
                  children: <Widget>[
                    trxHistory[index].containsKey("asset_code") 
                      ? Text(trxHistory[index]["asset_code"])
                      : Text("XLM"),
                    Container(
                      child: Text(timeStampToDateTime(trxHistory[index]['created_at'])),
                    )
                  ],
                ),
              ),
