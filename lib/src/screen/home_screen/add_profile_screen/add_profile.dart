...
class AddProfileState extends State<AddProfileWidget>{
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      key: _scaffoldKey,  
      drawer: drawerOnly(context, "addProfilescreen", logOut),
      appBar: appbarWidget(openDrawer, containerTitleAppBar('Add User Info'), snackBar),
      body: Mutation(
