...
class FromContactBody extends StatelessWidget{

  final ModelGetWalletFromContact modelGetWalletFromContact;
  final Function validatePhoneNumber;
  final Function onChanged;
  final Function onSubmit;
  final Function submitToContact;

  FromContactBody({
    this.modelGetWalletFromContact,
    this.validatePhoneNumber, 
    this.onChanged, 
    this.onSubmit, 
    this.submitToContact,
  });
